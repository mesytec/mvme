...
std::unique_ptr<VMEConfig> create_test_config_1()
{
    ...
    module1->getResetScript()->setId(QUuid::fromString(QSL("{00000000-0000-0000-0000-000000000006}")));
    module1->getReadoutScript()->setId(QUuid::fromString(QSL("{00000000-0000-0000-0000-000000000007}")));
