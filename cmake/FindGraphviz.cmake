...
if(GRAPHVIZ_FOUND)
    ...
    if(NOT Graphviz_FIND_QUIETLY)
      message("Graphviz include: ${GRAPHVIZ_INCLUDE_DIRS}")
      message("Graphviz libraries: ${GRAPHVIZ_CDT_LIBRARY} ${GRAPHVIZ_GVC_LIBRARY} ${GRAPHVIZ_CGRAPH_LIBRARY} ${GRAPHVIZ_PATHPLAN_LIBRARY}")
    endif()
